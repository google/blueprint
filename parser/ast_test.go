...
func TestManyComments(t *testing.T) {
	...
	var aList = NewList([]Expression{&String{"a"}}, false)
	var bList = NewList([]Expression{&String{"b"}}, false)
	...
	var module = &Module{&Token{"MyFirstModule"}, propertyMap}
	...
	tree.GetComments(module.Type).AppendPostComment(postModuleComment1)
	var postModuleComment2 = NewInlineComment("module comment")
	tree.GetComments(module.Type).AppendPostComment(postModuleComment2)
	...
	tree.GetComments(mapBody).AppendPreComment(mapTopComment)
	...
	tree.GetComments(mapBody).AppendPostComment(mapBottomComment)
	...
	tree.GetComments(one).AppendPreComment(preOneComment)
	...
	tree.GetComments(one).AppendPostComment(postOneComment)
	...
	tree.GetComments(firstPlus).AppendPreComment(prePlusOne)
	...
	tree.GetComments(firstPlus).AppendPostComment(postPlusOne)
	...
	tree.GetComments(two).AppendPreComment(preTwoComment)
	...
	tree.GetComments(two).AppendPostComment(postTwoComment)
	...
	tree.GetComments(aList).AppendPreComment(preAComment)
	...
	tree.GetComments(aList).AppendPostComment(postAComment)
